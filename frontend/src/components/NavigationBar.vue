...
a{
  ...
  .menu:hover, .end_menu:hover, h6:hover{
    color:#d4f6fc;
  }
...
header nav a:hover{
  background-color:rgb(178, 235, 202);
  color:black;
  -webkit-box-shadow: -2px 5px 71px 13px rgb(66, 63, 66);
  -moz-box-shadow: -2px 5px 71px 13px rgba(153,148,153,1);
